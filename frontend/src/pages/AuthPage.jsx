              ...
              <div className="auth-form-inner">
                ...
                {mode === 'signup' && role === 'customer' && (
                  <form onSubmit={handleCustomerSignup} autoComplete="off" style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                    ...
                    <div className="auth-field"><label className="auth-label"><User size={13} /> Full Name</label><div><input className="form-input-auth" type="text" placeholder="Rahul Kumar" autoComplete="name" value={custForm.name} onChange={e => setCustForm(p => ({ ...p, name: e.target.value }))} required /></div></div>
                    <div className="auth-field"><label className="auth-label"><Mail size={13} /> Email</label><div><input className="form-input-auth" type="email" placeholder="your@email.com" autoComplete="off" value={custForm.email} onChange={e => setCustForm(p => ({ ...p, email: e.target.value }))} required /></div></div>
                    <div className="auth-field"><label className="auth-label"><Phone size={13} /> Phone (optional)</label><div><input className="form-input-auth" type="tel" placeholder="+91 9876543210" autoComplete="off" value={custForm.phone} onChange={e => setCustForm(p => ({ ...p, phone: e.target.value }))} /></div></div>
                    <div className="auth-row">
                      <div className="auth-field"><label className="auth-label"><Lock size={13} /> Password</label><div style={{ position: 'relative' }}><input className="form-input-auth" type={showPwd ? 'text' : 'password'} placeholder="Min 6 chars" autoComplete="new-password" value={custForm.password} onChange={e => setCustForm(p => ({ ...p, password: e.target.value }))} required /><button type="button" className="auth-eye" onClick={togglePwd} tabIndex={-1}>{showPwd ? <EyeOff size={14} /> : <Eye size={14} />}</button></div></div>
                      <div className="auth-field"><label className="auth-label"><Lock size={13} /> Confirm</label><div><input className="form-input-auth" type={showPwd ? 'text' : 'password'} placeholder="Repeat" autoComplete="new-password" value={custForm.confirm} onChange={e => setCustForm(p => ({ ...p, confirm: e.target.value }))} required /></div></div>
                    </div>
                ...
                {mode === 'signup' && role === 'business' && (
                  <form onSubmit={handleBusinessSignup} autoComplete="off" style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                    ...
                    <div className="auth-row">
                      <div className="auth-field"><label className="auth-label"><Mail size={13} /> Email *</label><div><input className="form-input-auth" type="email" placeholder="biz@email.com" autoComplete="off" value={bizForm.email} onChange={e => setBizForm(p => ({ ...p, email: e.target.value }))} required /></div></div>
                    ...
                    <div className="auth-row">
                      <div className="auth-field"><label className="auth-label"><Lock size={13} /> Password *</label><div style={{ position: 'relative' }}><input className="form-input-auth" type={showPwd ? 'text' : 'password'} placeholder="Min 6 chars" autoComplete="new-password" value={bizForm.password} onChange={e => setBizForm(p => ({ ...p, password: e.target.value }))} required /><button type="button" className="auth-eye" onClick={togglePwd} tabIndex={-1}>{showPwd ? <EyeOff size={14} /> : <Eye size={14} />}</button></div></div>
                      <div className="auth-field"><label className="auth-label"><Lock size={13} /> Confirm *</label><div><input className="form-input-auth" type={showPwd ? 'text' : 'password'} placeholder="Repeat" autoComplete="new-password" value={bizForm.confirm} onChange={e => setBizForm(p => ({ ...p, confirm: e.target.value }))} required /></div></div>
                    </div>
