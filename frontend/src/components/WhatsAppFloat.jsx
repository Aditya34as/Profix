const WhatsAppFloat = () => {
  const message = encodeURIComponent(
    `Hi Pro Fix!  I need help with a home service.\n\n My Location: [Delhi NCR area]\n Service Needed: [AC Repair / Plumbing / Geyser]\n Issue: [Brief description]\n\nPlease send a technician at the earliest.`
  );

  return (
    <a
      href={`https://wa.me/9336124550?text=${message}`}
      target="_blank"
